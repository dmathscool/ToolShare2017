...
(3, 2, 3, 2, 'potato ricer', 'Cooking Tool', 'Oxo', 'Outstanding', ''),
(4, 2, 4, 3, 'sawzall', 'Power Tool', 'Milwalkee', 'Decent', ''),
(5, 2, NULL, 1, 'leaf blower', 'Lawn Tool', 'Stihl', 'Good', ''),
(6, 2, NULL, 1, 'leaf rake', 'Lawn Tool', 'Unknown', 'Terrible', ''),
(7, 2, 3, 2, 'spark plug gapper', 'Automotive Tool', 'Craftsman', 'Outstanding', ''),
(8, 3, NULL, 1, 'biscuit joiner', 'Power Tool', 'DeWalt', 'Outstanding', ''),
(9, 3, NULL, 1, 'power drill', 'Power Tool', 'DeWalt', 'Good', ''),
(10, 3, 2, 4, 'leaf blower', 'Lawn Tool', 'Husky', 'Fair', ''),
...
(17, 4, 2, 2, 'cookie spritzer', 'Cooking Tool', 'I dont know', 'Terrible', ''),
